---
title: Prices (JavaScript SDK)
sidebar_label: Prices
description: Retrieve the latest price for any supported stock symbol with the JavaScript SDK prices method, in raw or human-readable form.
sidebar_position: 1
---
...
- [`MarketDataPromise<StockPrice[] | StockPriceHuman[] | Blob>`](/sdk/js/client#MarketDataPromise)
