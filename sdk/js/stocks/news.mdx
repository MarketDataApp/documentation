---
title: News (JavaScript SDK)
sidebar_label: News
description: Retrieve news articles for any supported stock symbol with the JavaScript SDK news method, in raw or human-readable form.
sidebar_position: 5
---
