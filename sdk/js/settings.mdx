---
title: Settings (JavaScript SDK)
sidebar_label: Settings
description: Configure the JavaScript SDK output format, date format and data mode through several methods, and see which one wins when they disagree.
sidebar_position: 4
---
