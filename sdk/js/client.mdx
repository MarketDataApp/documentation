---
title: Client (JavaScript SDK)
sidebar_label: Client
description: The JavaScript SDK MarketDataClient handles requests, response parsing, retries, rate-limit tracking and logging for all five resource groups.
sidebar_position: 3
---
