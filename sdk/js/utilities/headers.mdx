---
title: Headers (JavaScript SDK)
sidebar_label: Headers
description: Echo back the request headers your JavaScript SDK client sent, to debug a proxy, custom header plumbing, or the user agent it presents.
sidebar_position: 2
---
