---
title: Utilities (JavaScript SDK)
sidebar_label: Utilities
description: The JavaScript SDK Utilities methods cover the two diagnostic endpoints, service status and request header inspection.
slug: /js/utilities
sidebar_position: 50
---
...
Rate-limit data is exposed on the client itself — see [`client.rateLimits`](/sdk/js/client#accessing-rate-limits), which the SDK populates automatically at startup from the same `/user/` response headers.
