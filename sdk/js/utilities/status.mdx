---
title: API Status (JavaScript SDK)
sidebar_label: Status
description: Retrieve health information for every Market Data endpoint with the JavaScript SDK. No token is needed, and the SDK probes it before a retry.
sidebar_position: 1
---
