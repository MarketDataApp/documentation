---
title: Authentication (JavaScript SDK)
sidebar_label: Authentication
description: Set your Market Data Bearer Token for the JavaScript SDK through an environment variable, a .env file, or by passing it to the client directly.
sidebar_position: 2
---
