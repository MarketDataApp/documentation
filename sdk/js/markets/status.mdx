---
title: Market Status (JavaScript SDK)
sidebar_label: Status
description: Retrieve open or closed market status for a range of dates and a country with the JavaScript SDK status method.
sidebar_position: 1
---
