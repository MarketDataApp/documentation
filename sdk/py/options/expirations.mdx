---
title: Expirations (Python SDK)
sidebar_label: Expirations
description: Get the current or historical option expiration dates for an underlying symbol with the Python SDK expirations method.
sidebar_position: 1
---
