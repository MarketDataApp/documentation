---
title: Option Quotes (Python SDK)
sidebar_label: Quotes
description: Retrieve quotes for one or more option symbols with the Python SDK quotes method, raw or in human-readable form.
sidebar_position: 5
---
...
Fetches option quotes for one or more option symbols. Note: `quotes()` takes option symbols (e.g., "AAPL271217C00250000"), not stock symbols. The `symbols` parameter can be passed as the first positional argument or as a keyword argument. All other parameters must be keyword-only.
...
df = client.options.quotes("AAPL271217C00250000")
# or
df = client.options.quotes(symbols="AAPL271217C00250000")

# Get quotes for multiple option symbols
df = client.options.quotes(["AAPL271217C00250000", "AAPL271217P00250000"])
...
quotes = client.options.quotes(
    ["AAPL271217C00250000", "AAPL271217P00250000"],
