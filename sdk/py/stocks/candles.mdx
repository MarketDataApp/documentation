---
title: Stock Candles (Python SDK)
sidebar_label: Candles
description: Retrieve historical price candles for any supported stock symbol with the Python SDK candles method, raw or human-readable.
sidebar_position: 2
---
