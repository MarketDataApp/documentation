---
title: Stock Quotes (Python SDK)
sidebar_label: Quotes
description: Retrieve live quotes for any supported stock symbol with the Python SDK quotes method, raw or in human-readable form.
sidebar_position: 3
---
