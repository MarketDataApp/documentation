---
title: Prices (Python SDK)
sidebar_label: Prices
description: Retrieve the latest price for any supported stock symbol with the Python SDK prices method, raw or in human-readable form.
sidebar_position: 1
---
