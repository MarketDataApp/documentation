...
description: The Python SDK MarketDataClient makes requests, parses responses, tracks rate limits and logs, across stocks, options, funds and market status.
sidebar_position: 3
---
...
- `rate_limits` ([UserRateLimits](#accessing-rate-limits)): Current rate limit information
...
- `options` ([OptionsResource](/sdk/py/options)): Access to options endpoints (chain, expirations, quotes, lookup)
