---
title: Fund Candles (Python SDK)
sidebar_label: Candles
description: Retrieve historical price candles for any supported fund symbol with the Python SDK candles method, raw or human-readable.
sidebar_position: 1
---
