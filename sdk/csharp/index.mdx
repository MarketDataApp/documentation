---
title: C# / .NET SDK
description: The Market Data C# and .NET SDK ships typed records, an async-first API with cancellation, automatic retries and a focused exception hierarchy.
sidebar_position: 6
slug: /csharp
