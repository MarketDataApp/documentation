...
- **`Microsoft.Extensions.Configuration`** (with the user-secrets provider), **`Microsoft.Extensions.Logging`**, and **`Microsoft.Extensions.DependencyInjection`** for configuration binding, structured logging, and the `AddMarketDataClient` service-collection extension.
