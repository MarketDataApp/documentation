...
var quote = (await client.Options.GetQuoteAsync("AAPL250117C00150000")).Values[0];
...
var quotes = await client.Options.GetQuotesAsync(["AAPL250117C00150000", "AAPL250117P00150000"]);
