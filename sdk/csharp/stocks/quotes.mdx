---
title: "Stock Quotes (C# SDK)"
sidebar_label: Quotes
description: Retrieve real-time bid, ask, mid, last and volume for one or more stock symbols with the C# SDK, in single or multi-symbol form.
sidebar_position: 2
---
