...
description: Set your Market Data Bearer Token for the C# SDK through an environment variable, .NET user secrets, a .env file, or a direct constructor argument.
sidebar_position: 2
---
