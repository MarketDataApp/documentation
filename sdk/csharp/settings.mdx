---
title: "Settings (C# SDK)"
sidebar_label: Settings
description: Configure the C# SDK at two levels, client options set once and request options passed per call, and see how universal parameters cascade between them.
sidebar_position: 4
---
