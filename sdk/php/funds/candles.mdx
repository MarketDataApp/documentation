---
title: Fund Candles (PHP SDK)
sidebar_label: Fund Candles
description: Get historical open, high, low, close and volume candles for a mutual fund with the PHP SDK candles method.
sidebar_position: 1
---
