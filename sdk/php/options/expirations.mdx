---
title: Expirations (PHP SDK)
sidebar_label: Expirations
description: Get the current or historical option expiration dates for an underlying symbol with the PHP SDK expirations method.
sidebar_position: 2
---
