---
title: Error Handling (PHP SDK)
sidebar_label: Error Handling
description: The PHP SDK raises a hierarchy of exceptions, from MarketDataException down to the specific request and status errors you can catch individually.
sidebar_position: 7
---
