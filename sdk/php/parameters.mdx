---
title: Parameters (PHP SDK)
sidebar_label: Parameters
description: Configure the PHP SDK output format, date format and data mode through several methods, and see which priority level wins when they disagree.
sidebar_position: 5
---
