---
title: Stock Quote (PHP SDK)
sidebar_label: Quote
description: Get a real-time price quote for a single stock symbol with the PHP SDK quote method, which returns one Quote object.
sidebar_position: 2
---
