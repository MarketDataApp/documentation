---
title: Bulk Candles (PHP SDK)
sidebar_label: Bulk Candles
description: Retrieve one daily candle for each of many stock symbols in a single PHP SDK request, which suits a whole-market snapshot.
sidebar_position: 7
---
