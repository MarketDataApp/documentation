---
title: Earnings (PHP SDK)
sidebar_label: Earnings
description: Get historical earnings per share, or a calendar of upcoming reports, for a stock symbol with the PHP SDK earnings method.
sidebar_position: 5
---
