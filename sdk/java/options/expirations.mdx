---
title: Expirations (Java SDK)
sidebar_label: Expirations
description: List the available option expiration dates for an underlying symbol with the Java SDK and its OptionsExpirationsRequest type.
sidebar_position: 2
---
