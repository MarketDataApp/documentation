---
title: Markets (Java SDK)
sidebar_label: Markets
description: The Java SDK wraps the Market Data Markets endpoints in typed sync and async methods that report whether a market was open on a date.
slug: /java/markets
sidebar_position: 40
---
