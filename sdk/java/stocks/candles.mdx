---
title: Stock Candles (Java SDK)
sidebar_label: Candles
description: Retrieve historical open, high, low, close and volume candles for a stock with the Java SDK StockCandlesRequest and its resolution options.
sidebar_position: 1
---
