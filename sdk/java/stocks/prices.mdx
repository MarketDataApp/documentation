---
title: Prices (Java SDK)
sidebar_label: Prices
description: Retrieve the latest mid price and change for one or more stock symbols with the Java SDK StockPricesRequest, a lighter payload than a quote.
sidebar_position: 3
---
