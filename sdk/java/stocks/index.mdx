---
title: Stocks (Java SDK)
sidebar_label: Stocks
description: The Java SDK wraps the Market Data Stocks endpoints in typed sync and async methods for candles, quotes, prices, earnings and news.
slug: /java/stocks
sidebar_position: 10
---
