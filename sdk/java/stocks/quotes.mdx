---
title: Stock Quotes (Java SDK)
sidebar_label: Quotes
description: Retrieve real-time bid, ask, mid, last and volume for one or more stock symbols with the Java SDK, in single or multi-symbol request form.
sidebar_position: 2
---
