---
title: Funds (Java SDK)
sidebar_label: Funds
description: The Java SDK wraps the Market Data Funds endpoints in typed methods, each available in a synchronous and a CompletableFuture form.
slug: /java/funds
sidebar_position: 30
---
