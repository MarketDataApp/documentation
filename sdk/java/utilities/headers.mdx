---
title: Headers (Java SDK)
sidebar_label: Headers
description: Echo back the headers the Market Data API received with the Java SDK, to confirm your Authorization header arrived. Sensitive values are redacted.
sidebar_position: 3
---
