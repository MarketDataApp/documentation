...
description: MarketDataClient is the Java SDK entry point, reaching all five resources and handling parsing, retries with backoff, rate limits and logging.
sidebar_position: 3
---
