---
title: Authentication (Java SDK)
sidebar_label: Authentication
description: Set your Market Data Bearer Token for the Java SDK through an environment variable, a .env file, or by passing it straight to the client.
sidebar_position: 2
---
