...
Raw executes the StockNewsRequest and returns the raw \*resty.Response. This method optionally accepts a \*MarketDataClient to use for the request, replacing the default client if provided. The \*resty.Response allows access to the raw JSON or \*http.Response for further processing.
