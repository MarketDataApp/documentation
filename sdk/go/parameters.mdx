...
description: Universal Market Data parameters work on every endpoint. In the Go SDK you set them as client-level functional options that apply to each request.
sidebar_position: 5
---
