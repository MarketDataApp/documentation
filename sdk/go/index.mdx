---
title: Go SDK
description: The Market Data Go SDK v2 gives type-safe access to stock, option, fund and market data using nothing but the Go standard library at runtime.
slug: /go
sidebar_position: 7
---
