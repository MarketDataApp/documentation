...
description: The Go SDK returns typed errors you inspect with errors.Is and errors.As, each carrying request details and a sentinel for quick classification.
sidebar_position: 7
---
