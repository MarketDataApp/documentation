...
const RELEVANCE = [
  ...
  { q: 'stock candles', want: '/api/stocks/candles', known: 'SDK title embeds the section; API title is bare' },
  { q: 'option quotes', want: '/api/options/quotes', known: 'SDK title embeds the section; API title is bare' },
  { q: 'bulk candles', want: '/api/stocks/bulkcandles', known: 'SDK title embeds the section; API title is bare' },
  { q: 'earnings', want: '/api/stocks/earnings', known: 'SDK title embeds the section; API title is bare' },
  ...
  { q: 'php sdk', want: '/sdk/php', known: 'every page in the section matches "(PHP SDK)" equally' },
  { q: 'python sdk', want: '/sdk/py', known: 'every page in the section matches "(Python SDK)" equally' },
  { q: 'go sdk', want: '/sdk/go', known: 'every page in the section matches "(Go SDK)" equally' },
  { q: 'google sheets', want: '/sheets', known: 'thin section index loses to a deep page' },
  { q: 'billing portal', want: '/account/billing-portal', known: 'loses to its own troubleshooting page' },
  ...
  { q: 'troubleshooting', want: '/api/troubleshooting', known: 'API/Sheets tie; demoting Sheets costs optionchain' },
  { q: 'market status', want: '/api/markets/status', known: 'API/Sheets tie; demoting Sheets costs optionchain' },
