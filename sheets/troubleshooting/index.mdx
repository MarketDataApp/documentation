---
title: Troubleshooting (Sheets)
sidebar_label: Troubleshooting
description: Most Google Sheets add-on errors come from limits Google places on add-ons. Learn the limits and how to avoid the errors they cause.
