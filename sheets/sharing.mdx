...
description: Share a sheet that uses Market Data formulas. Every recipient needs the add-on installed and a Market Data account of their own.
sidebar_position: 4
---
...
## Sharing with Free or Trial Users

You can share your sheet with free or trial users but these users will not have access to real-time data. They will only have access to delayed and historical data. If you need to share your sheet with another user who needs real-time data, each user will need to have a paid Market Data account.