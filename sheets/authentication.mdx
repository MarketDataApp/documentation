---
title: Authentication (Sheets)
sidebar_label: Authentication
description: The Sheets add-on signs in with your Google account and links to the Market Data account that uses the same e-mail address.
sidebar_position: 2
---
...
:::warning
If you registered for Market Data with an e-mail address different from the one you use to log in to Google, you must update your Market Data account's e-mail to match your Google Sheets login e-mail.
:::
...
Almost all issues related to authentication can be solved by changing your Market Data account's e-mail address to the same e-mail address you use to login to Google Sheets.
