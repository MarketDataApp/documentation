...
- **Specific Contract Expirations** - Target a specific date based on when a contract is first traded or when it expires.
  ...
  - `at expiration` - Returns the expiration date for the option contract. This must be used in the context of a specific option contract. For example, if you used at expiration with AAPL271217C00250000, the date returned would be December 17, 2027.

  - `first traded` - Returns the date when the contract was traded for the first time. This must be used in the context of a specific option contract. For example, if you used first traded with AAPL271217C00250000, the date returned would be March 13, 2025.
