...
If Market Data is unable to confirm your non-professional status — for example, because your profile is incomplete or your information cannot be verified — your account will be restricted to delayed and historical data until verification is complete. See [Account Compliance](/docs/account/compliance/) for details on the verification process.
