---
title: CORS
description: The Market Data API sends CORS headers so you can call it from a browser for development or personal use. Learn what that permits and what it does not.
sidebar_position: 4
---
