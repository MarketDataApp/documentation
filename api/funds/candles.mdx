---
title: Mutual Fund Candles
sidebar_label: Candles
description: Get historical open, high, low, close and volume candles for a mutual fund, with the request parameters and response attributes documented.
sidebar_position: 1
