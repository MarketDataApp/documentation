...
:::note
  - When the market is open for primary trading, **change** and **changepct** are calculated using the last traded price and the last close.
  - When extended is omitted or set to `true`, **change** and **changepct** are calculated using the last traded price and the last close.
  - When extended is set to `false`, and the market is closed or in extended hours, **change** and **changepct** are calculated using the last two closing prices.
:::
