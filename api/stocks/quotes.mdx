...
Entitlements are permissions granted by exchanges that allow access to their data. To get real-time quotes, non-professional users need to sign the [IEX agreement](/account/entitlements). [Learn more about entitlements](/account/entitlements).
:::
