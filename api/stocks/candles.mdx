...
Entitlements are permissions granted by exchanges that allow access to their data. To get 15-minute delayed candles, non-professional users need to sign the [UTP entitlement agreement](/account/entitlements). [Learn more about entitlements](/account/entitlements).
:::
...
|--------------------|---------------------------|---------------------------|
| Candle Data    | Per 1000 candles         | 1 credit                  |
