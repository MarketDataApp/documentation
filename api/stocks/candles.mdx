...
Entitlements are permissions granted by exchanges that allow access to real-time data. To get real-time candles, non-professional users need to sign the [UTP entitlement agreement](/account/entitlements). [Learn more about entitlements](/account/entitlements).
:::
