...
Entitlements are permissions granted by exchanges that allow access to real-time data. This endpoint does not require any exchange entitlements and provides real-time prices to all users. [Learn more about entitlements](/account/entitlements).
:::
