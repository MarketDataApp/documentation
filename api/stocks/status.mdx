...
**GET** [https://api.marketdata.app/v1/stocks/status/AAPL/](https://api.marketdata.app/v1/stocks/status/AAPL/)

**GET** [https://api.marketdata.app/v1/stocks/status/AAPL/?date=2024-07-04](https://api.marketdata.app/v1/stocks/status/AAPL/?date=2024-07-24)
...
```js title="app.js"
fetch(
  "https://api.marketdata.app/v1/stocks/status/?symbol=AAPL"
)
  .then((res) => {
    console.log(res);
  })
...
fetch("https://api.marketdata.app/v1/stocks/status/?symbol=AAPL&date=2024-07-04")
  .then((res) => {
    console.log(res);
  })
  .catch((err) => {
...
url1 = "https://api.marketdata.app/v1/stocks/status/?symbol=AAPL"
url2 = "https://api.marketdata.app/v1/stocks/status/?symbol=AAPL&date=2024-07-04"
...
- **status** `object`
  ...
  - **exchangeTime** `string`
    ...
    The current time at the exchange in ISO 8601 format.
...
- **previous** `object`
  ...
  - **date** `string`
    ...
    The previous date in ISO 8601 format.
...
- **next** `object`
  ...
  - **date** `string`
    ...
    The next date in ISO 8601 format.
