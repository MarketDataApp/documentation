...
The Market Data API uses a bearer token for authentication. The token is required for each request you make to the API. You may use header authentication or url parameter authentication.
