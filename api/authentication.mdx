...
To avoid account sharing, the Market Data API allows a single IP address for each account to be used at a time. If your IP address changes, your account will be temporarily blocked for security reasons even if you are authenticated. Please wait 5 minutes before trying again.
