...
description: Learn which parts of a Market Data API request belong in the URL path and which belong in the query string, and the mistakes that cause a 400.
sidebar_position: 3
---
