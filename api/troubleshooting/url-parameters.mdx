...
```
https://<span style="color:blue">api.marketdata.app</span>/<span style="color:green">v1/stocks/quotes/SPY/</span>?<span style="color:red">token=token1234&dateformat=timestamp</span>
```

- **Protocol**: `https://`
- **Host**: <span style="color:blue">`api.marketdata.app`</span>
- **Path (or Endpoint)**: <span style="color:green">`/v1/stocks/quotes/SPY/`</span>
- **Query String**: Begins with a `?` and includes <span style="color:red">`token=token1234&dateformat=timestamp`</span>
