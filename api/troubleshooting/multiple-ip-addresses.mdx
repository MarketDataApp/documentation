...
If you encounter an issue where your account is temporarily blocked due to accessing the API from multiple devices, follow these steps to resolve it. For background on why this restriction exists, see the [Single IP Address Policy](/docs/account/data-policies/single-ip-policy/).
