...
description: Confirm a Market Data outage from the status page or programmatically, and learn what to do while the service is unavailable.
sidebar_position: 13
---
