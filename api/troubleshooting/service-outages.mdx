...
Use the [/utilities/status/ endpoint](/utilities/status) to confirm the status of all Market Data services, including our APIs. This endpoint will remain online during outages and will a JSON response that includes the status of all Market Data services. 
