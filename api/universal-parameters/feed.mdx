...
This parameter can only be used with paid plans. Free plans or trial plans do not have the ability to control their data feed.
:::
...
| **Access**         | Paid plans only                 | Free and trial plans                |
