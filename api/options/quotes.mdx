...
The type of option quote data you receive depends on your user type and OPRA entitlement (permissions granted by exchanges that allow access to real-time data). This may include real-time data, 15-minute delayed data, or historical data, depending on the plan or access level. To get real-time options data, users need to sign the OPRA agreement. [Learn more about entitlements](/account/entitlements).
