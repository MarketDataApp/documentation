...
:::tip
This endpoint will continue to respond with the current status of the Market Data API, even if the API is offline. If the API is offline, the response will include the last known status and uptime percentages. This endpoint is public and does not require a token.
:::
