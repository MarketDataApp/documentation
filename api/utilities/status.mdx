---
title: API Status
description: Check the current status of Market Data services and historical uptime for the last 30 and 90 days. The status refreshes every five minutes.
sidebar_position: 1
