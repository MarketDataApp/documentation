...
## Request Example
    ...
    /candles/D/AAPL?from=2020-01-01&to=2020-12-31

    /candles/D/AAPL?from=2020-12-31&countback=252
...
- **symbol** `string`
  ...
  The company's ticker symbol. If no exchange is specified, by default a US exchange will be assumed. You may embed the exchange in the ticker symbol using the Yahoo Finance or TradingView formats. A company or securities identifier can also be used instead of a ticker symbol. Ticker Formats: (`TICKER`, `TICKER.EX`, `EXCHANGE:TICKER`)
